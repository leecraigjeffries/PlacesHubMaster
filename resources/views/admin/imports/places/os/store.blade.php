...
@section('title')
    {!! Breadcrumbs::view('app._title', 'admin.imports.places.os.store') !!}
@endsection

@section('breadcrumbs')
    {!! Breadcrumbs::render('admin.imports.places.os.store') !!}
@endsection
...
@section('admin.content')
    ...
    <div class="row">
        <div class="col text-center">
            ...
            @else
                <a href="{{ route('admin.imports.places.os.create') }}">@lang('admin.click_to_return')</a>
            @endif
        </div>
    </div>
