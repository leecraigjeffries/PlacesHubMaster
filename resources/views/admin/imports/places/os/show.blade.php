...
@section('title')
    {!! Breadcrumbs::view('app._title', 'admin.imports.places.os.show', $osPlace) !!}
@endsection

@section('breadcrumbs')
    {!! Breadcrumbs::render('admin.imports.places.os.show', $osPlace) !!}
@endsection
...
@section('app.content')
    ...
    @foreach($osPlace->childTypes() as $childType)
        @include('admin.imports.places.os._data-table', ['type' => $childType, 'osPlace' => $osPlace])
    @endforeach
