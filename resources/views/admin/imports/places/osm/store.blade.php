...
@section('title')
    {!! Breadcrumbs::view('app._title', 'admin.imports.places.osm.store') !!}
@endsection

@section('breadcrumbs')
    {!! Breadcrumbs::render('admin.imports.places.osm.store') !!}
@endsection

@section('heading')
    @lang('admin.import_osm_places')
@endsection
...
@section('admin.content')
    ...
    <div class="row">
        <div class="col text-center">
            ...
            @else
                <a href="{{ route('admin.imports.places.osm.create') }}">@lang('admin.click_to_return')</a>
            @endif
        </div>
    </div>
