...
class CreateGeoPlaceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up(): void
    {
        Schema::create('geo_places', static function (Blueprint $table) {
            $table->increments('id');
            $table->string('geo_code')->collation('ascii_bin')->nullable();
            ...
            $table->string('adm1_code')->collation('ascii_bin')->nullable();
            $table->string('adm1_name')->nullable();
            $table->integer('adm2_id')->unsigned()->index()->nullable();
            $table->string('adm2_code')->collation('ascii_bin')->nullable();
            $table->string('adm2_name')->nullable();
            $table->integer('adm3_id')->unsigned()->index()->nullable();
            $table->string('adm3_code')->collation('ascii_bin')->nullable();
